...
### Output:
![First letter example](output-1.png)
...
### Output:
![First line example](output-2.png)
...
![Viewport resize example](output-3.png)
...
### Output:
![Selection example](output-4.png)
...
### Output:
![Before and after example](output-6.png)
